...
/*!**********************!*\
  !*** ./src/HW5JS.js ***!
  \**********************/
/*! exports provided: generateCombinations */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"generateCombinations\", function() { return generateCombinations; });\nconst generateCombinations = word => {\n  if (word.length < 2) {\n    return word;\n  }\n\n  let permutationsArray = [];\n\n  for (let i = 0; i < word.length; i++) {\n    let letter = word[i];\n    let remainingChars = word.slice(0, i) + word.slice(i + 1, word.length);\n\n    for (let permutation of generateCombinations(remainingChars)) {\n      permutationsArray.push(letter + permutation);\n    }\n  }\n\n  return permutationsArray;\n};\n\n//# sourceURL=webpack:///./src/HW5JS.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _HW3JS__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./HW3JS */ \"./src/HW3JS.js\");\n/* harmony import */ var _HW5JS__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./HW5JS */ \"./src/HW5JS.js\");\n/* harmony import */ var _HW11JS__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./HW11JS */ \"./src/HW11JS.js\");\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index.css */ \"./src/index.css\");\n\n\n\n\ndocument.body.innerHTML = `<table>\n<tr>\n  <td><button id=\"genDigitalPasBtn\">Generate digital password</button></td>\n  <td><button id=\"genChinesePasBtn\">Generate сhinese password</button></td>\n</tr>\n<tr>\n  <td>Legth of password:</td>\n  <td><input id=\"lengthOfPasswordInput\" /></td>\n</tr>\n<tr>\n  <td>Result:</td>\n  <td id=\"resultOutput\"></td>\n</tr>\n<tr>\n  <td>Other combinations:</td>\n  <td id=\"otherCombinations\"></td>\n</tr>\n</table>`;\n\nconst showDigitalPassword = () => {\n  debugger;\n  const resultOutput = document.querySelector('#resultOutput');\n  const lengthOfPassword = document.querySelector('#lengthOfPasswordInput').value;\n  resultOutput.textContent = Object(_HW3JS__WEBPACK_IMPORTED_MODULE_0__[\"getRandomPassword\"])(lengthOfPassword).toString();\n  const otherCombinationsOutput = document.querySelector('#otherCombinations');\n  otherCombinationsOutput.textContent = Object(_HW5JS__WEBPACK_IMPORTED_MODULE_1__[\"generateCombinations\"])(Object(_HW3JS__WEBPACK_IMPORTED_MODULE_0__[\"getRandomPassword\"])(lengthOfPassword).toString());\n};\n\nconst showChinesePassword = () => {\n  debugger;\n  const resultOutput = document.querySelector('#resultOutput');\n  const lengthOfPassword = document.querySelector('#lengthOfPasswordInput').value;\n  Object(_HW11JS__WEBPACK_IMPORTED_MODULE_2__[\"getRandomChinese\"])(lengthOfPassword).then(result => resultOutput.textContent = result.toString()).then(result => {\n    const otherCombinationsOutput = document.querySelector('#otherCombinations');\n    otherCombinationsOutput.textContent = Object(_HW5JS__WEBPACK_IMPORTED_MODULE_1__[\"generateCombinations\"])(result);\n  });\n};\n\ndocument.querySelector('#genDigitalPasBtn').addEventListener('click', showDigitalPassword);\ndocument.querySelector('#genChinesePasBtn').addEventListener('click', showChinesePassword);\n\n//# sourceURL=webpack:///./src/index.js?");
